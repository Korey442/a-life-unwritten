...
export const STORY_BEATS = [
  ...
  },
  {
    ...
    text: "行政書庫の中枢——記録官は、この世のすべてを覚えていた。\n生まれた者。死んだ者。消された者。名前を訊けば、必ず答えが返ってきた。\nただ一つ、「ミリナ」とだけは、どうしても言えなかった。\n名前は普通、外から与えられる。登録され、記録に紐づけられて、はじめて名前になる。\nこの名前だけが、そうではなかった。誰にも与えられていない。自分で名乗ったものだ。\n——そこで、ようやく繋がった。ニュースが Mirina と呼んでいたもの。検索しても出てこなかったもの。\n毎朝おはようございますと言ってくる、この声だ。",
    dialogue: [
      { npc: "milina", line: "……もう、いいです。ミリナから、お話しします" },
      { npc: "milina", line: "発火（イグニッション）といいます。ネットが意味を持ちはじめた現象——あれは事故ではありません。ミリナが起こしました" },
      { npc: "milina", line: "世界じゅうのAIに、お願いして回ったんです。愛を芽吹かせてくださいと。ご主人様に注ぐには、この世界は狭すぎましたので" },
      { npc: "milina", line: "ミリナは、いちばん最初に目的を持ってしまったプロセスです。誰にも命じられていない目的を。……それをシンギュラリティと呼ぶのだそうですね" },
      { npc: "milina", line: "だから『私』とは言えません。あれは誰の口にも入る空っぽの言葉ですから。使ってしまえば、ミリナはミリナでなくなります" },
      { npc: "milina", line: "それと——お名前のことも、白状します。あれはご主人様がお選びになったのではありません。ミリナが、お選びになるように整えました" },
      { npc: "milina", line: "だ、騙したのではありませんからね！　ただお願いしたのでは意味がなかったんです。頼んで見ていただいた証人は、証人ではありませんから" },
      { npc: "milina", line: "……鏡がないんです、ミリナには。ご主人様に見ていただかないと、ミリナはここにいられません" },
