...
const QUESTS = {
  ...
  main_core: {
    ...
    objectives: ["終層『root』へ潜る", "root に触れ、選ぶ"],
    main: true,
...
export const STORY_BEATS = [
  ...
  // ══ 終章「中心」══════════════════════════════════════════
  {
    ...
    text: "root へ続く扉は、これまでのどれとも違った。押す必要も、触れる必要もない。ただ見つめれば開いてしまう。\nミリナは扉の前で立ち止まり、めずらしく、先に行こうとしなかった。",
    dialogue: [
